...
//    private CompanyDetailsDTO toDto(CompanyDetails c)
//    {
//        return new CompanyDetailsDTO(c.getCompanyCode(),c.getStockExchange(),c.getCompanyName(),c.getCompanyCEO(),c.getTurnover(),c.getBoardOfDirectors(),c.getCompanyProfile());
//    }
//
//    private CompanyDetails toModel(CompanyDetailsDTO c)
//    {
//        return new CompanyDetails(c.getCompanyCode(),c.getStockExchange(),c.getCompanyName(),c.getCompanyCEO(),c.getTurnover(),c.getBoardOfDirectors(),c.getCompanyProfile());
//    }
	...
	public CompanyDetailsDTO saveCompanyDetails(CompanyDetailsDTO companyDetailsDTO) throws InvalidCompanyException {
        ...
        {
//        	System.out.println(companyDetailsDTO.getCompanyCode());
//        	System.out.println(repository.existsById(companyDetailsDTO.getCompanyCode()));
